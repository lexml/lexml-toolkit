...
public class NodeRecordFactory extends RecordFactory {
	...
	/**
	 * Construct an NodeRecordFactory capable of producing the Crosswalk(s) specified in the properties file.
	 * 
	 * @param properties
	...
	private static HashMap getCrosswalkMap(String sruURL, boolean enrich) throws IllegalArgumentException {
		try {
			...
			NodeList schemas = XPathAPI.selectNodeList(explainDoc, "/srw:explainResponse/srw:record/srw:recordData/explain:explain/explain:schemaInfo/explain:schema",
					xmlnsEl);
	...
	// NodeList nodeList = XPathAPI.selectNodeList(sruDoc,
	// "/srw:searchRetrieveResponse/srw:records/srw:record/srw:recordData/mets:mets[mets:structMap/mets:div/mets:div[@LABEL='target']/mets:div[@LABEL='Application']/mets:div[@LABEL='infoURI']]",
	// xmlnsEl);

	// for (int i=0; i<nodeList.getLength(); ++i) {
	// Node recordNode = nodeList.item(i);
	// String infoURIFID = XPathAPI.eval(recordNode,
	// "mets:structMap/mets:div/mets:div[@LABEL='target']/mets:div[@LABEL='Application']/mets:div[@LABEL='infoURI']/mets:fptr/@FILEID", xmlnsEl).str();
	...
	// String namespaceFID = XPathAPI.eval(recordNode,
	// "mets:structMap/mets:div/mets:div[@LABEL='target']/mets:div[@LABEL='Application']/mets:div[@LABEL='namespace']/mets:fptr/@FILEID", xmlnsEl).str();
	// String namespace = XPathAPI.eval(recordNode, "mets:fileSec/mets:fileGrp[@USE='Application']/mets:file[@ID='"+namespaceFID+"']/mets:FLocat/@xlink:href",
	// xmlnsEl).str();
	...
	// String crosswalkFID = XPathAPI.eval(recordNode, "mets:structMap/mets:div/mets:div[@LABEL='crosswalk']/mets:div[@LABEL='Application']/mets:fptr/@FILEID",
	// xmlnsEl).str();
	// String crosswalk = XPathAPI.eval(recordNode, "mets:fileSec/mets:fileGrp[@USE='Application']/mets:file[@ID='"+crosswalkFID+"']/mets:FLocat/@xlink:href",
	// xmlnsEl).str();
